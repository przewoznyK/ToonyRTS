...
public class MeleeWarrior : Unit
{
    ...
    {
        //Debug.Log(" PlayerRightMouseButtonCommand");
        //if (isShiftPressed == false && unitTaskManager.requestedTasks.Count > 0)
        //{
        //    Debug.Log(" PlayerRightMouseButtonCommand Reset Task");
        //   // unitTaskManager.RequestToServerToResetTasks();
        //}

        //if (hit.collider.CompareTag("Ground"))
        //{
        //    Debug.Log(" PlayerRightMouseButtonCommand RequestToServerToCreateGoToPositionTask");
        //    //unitTaskManager.RequestToServerToCreateGoToPositionTask(hit.point);
        //    unitTaskManager.Test(hit.point, isShiftPressed);
        //}
